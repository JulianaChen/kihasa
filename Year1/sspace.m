...
eps_i = sqrt(2)*e*params(23); % error vector
...
Teps_i=chebpoly_base(Ne-1,zeps_i);
...
S = struct(...
    ...
    'nK',nK,'extmin_K',extmin_K,'extmax_K',extmax_K,'d_K',d_K,'T_K',T_K,'T2_K',T2_K,'eps_r',eps_r,'eps_n',eps_n);
