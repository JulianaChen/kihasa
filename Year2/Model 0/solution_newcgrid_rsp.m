function [v_func_rsp,c_func,c_func_rsp,m_func,m_func_rsp,lr_func,lr_func_rsp,ln_func,ln_func_rsp,lu_func,lu_func_rsp] = solution_newcgrid_rsp(G,abi,edu,S,params)
...
%                 for t=1:19
%                 prob_marr_w(:,t) = omega0_w + omega11*(edu==2) + omega12*(edu==3) + omega2*t;
%                 prob_marr_u(:,t) = omega0_u + omega11*(edu==2) + omega12*(edu==3) + omega2*t;
%                 end
