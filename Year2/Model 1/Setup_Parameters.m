...
%Family Background Types (11-14) (EST)
alpha01_r=4.246;
alpha01_n=3.921;
alpha02_r=0.0995;
alpha02_n=0.0115;

%Return to 2yr College (15-16) (EST)
alpha11_r=0.116;
alpha11_n=0.016;

%Return to 4yrs college(17-18) (EST)
alpha12_r=0.474;
alpha12_n=0.174;

%Return to General Work Experience (19-20) (EST)
alpha2_r=0.437;
alpha2_n=0.302;
%unemployed?
...
% Probability of marriage (24-28) (CAL)
omega0_w  =  -0.066; 
omega0_u  =  0.401; 
omega11 = - 0.0581;
omega12 = - 0.0904;
...
% husband wages (regression coefficients on means/sd) (CAL)
eta01=6.685;
eta02=0.00000000825;
eta11=0.218;
eta12=0.297;
...
% child investment (regression coefficients on means/sd) (CAL)
iota01=2.426;
...
% probabiliteis of losing a regular job (CAL)
tau10=2.282;
tau11=-0.155;
tau12=-0.297;
tau13=-0.405;
...
% probabiliteis of getting a regular job  (CAL)
tau20=-2.105;
tau21=0.209;
tau22=0.0424;
tau23=-0.324;
